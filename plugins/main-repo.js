...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/Bladehack2/CASCADEUR-XDR';
    ...
    try {
        ...
        const botname = "CASCADEUR-MD";

        const styleCustom = `*ʜᴇʟʟᴏ ,,,👋 ᴛʜɪs ɪs ${botname}*
ᴛʜᴇ ʙᴇsᴛ ʙᴏᴛ ɪɴ ᴛʜᴇ ᴜɴɪᴠᴇʀsᴇ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ᴏᴛʜɪɴɪᴇʟ ᴋᴀᴛᴇᴄʜ. ғᴏʀᴋ ᴀɴᴅ ɢɪᴠᴇ ᴀ sᴛᴀʀ 🌟 ᴛᴏ ᴍʏ ʀᴇᴘᴏ
╭───────────────────
